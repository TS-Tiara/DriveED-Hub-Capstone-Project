...
<div class="lms-page">
    <div class="lms-header">
        <div>
            ...
            <p class="lms-subtitle">Select a course, then manage its modules and lessons.</p>
        </div>
    ...
    @if($practicalCount === 0)
        <div class="materials-banner">
            No PDC course is tagged as practical right now. Check course type in Courses if practical classes are missing.
        </div>
    @endif
            ...
            @foreach($courses as $course)
                ...
                <article class="materials-card">
                    ...
                    <div class="materials-actions">
                        <a href="{{ school_route('admin.courses.modules.index', ['course' => $course->id]) }}" class="lms-btn lms-btn-primary">Open Materials</a>
                    </div>
                </article>
            @endforeach
        </div>
