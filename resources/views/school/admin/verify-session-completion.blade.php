...
@section('content')
    ...
    <div class="admin-container">
        ...
        <div class="stats-grid"
            ...
            <div class="stat-card stat-card-clickable" id="card-all"
            ...
            <div class="stat-card stat-card-clickable" id="card-done"
                ...
                onclick="filterBookings('done', this)">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <div
            ...
            <div class="stat-card stat-card-clickable"
                ...
                onclick="filterBookings('completed', this)">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <div
                            style="color: #6b7280; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">
            ...
            <div class="stat-card stat-card-clickable"
                ...
                onclick="filterBookings('flagged', this)">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <div
                            style="color: #6b7280; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 5px;">
                    ...
                    <div class="booking-details">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                <span
                                    class="badge badge-{{ $booking->payment_status === 'paid' ? 'success' : ($booking->payment_status === 'partial' ? 'warning' : 'secondary') }}">
                    ...
                    <div class="booking-actions">
                        <select class="status-select" onchange="updateStatus({{ $booking->id }}, this.value)">
                            ...
                            <optgroup label="Final Audit">
                                <option value="completed" {{ $booking->status == 'completed' ? 'selected' : '' }}>Verify & Log
                                    Session</option>
                            </optgroup>
                        ...
                        @if(!$booking->payment)
                            <button class="btn btn-success btn-sm" onclick="createPayment({{ $booking->id }})">Record
                                Payment</button>
                        @else
        ...
        function filterBookings(status, element) {
            ...
            cards.forEach(card => {
                if (status === 'all') {
                    ...
                    card.style.display = (s === 'cancelled' || s === 'no-show' || s === 'no_show') ? 'block' : 'none';
                } else {
