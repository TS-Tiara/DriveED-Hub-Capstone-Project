...
<head>
    ...
    <title>Forgot Password - System Admin</title>
    <style>
...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <p>Enter your system administrator email to receive a secure recovery link.</p>
        </div>

        <form method="POST" action="{{ route('system-admin.password.email') }}">
            @csrf
