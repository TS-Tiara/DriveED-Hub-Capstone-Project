            ...
            if (isset($data['course_idx']) && isset($courses[$data['course_idx']])) {
                ...
                \App\Models\EnrollmentRequest::updateOrCreate(
                    ...
                    [
                        ...
                        'payment_proof_path' => $email === 'guest1@driveedhub.test' ? 'guest-data/guest_receipt.jpg' : null,
                        'credentials_file_path' => $email === 'guest1@driveedhub.test' ? 'guest-data/guest_permit.jpg' : null,
