...
<div class="payments-container">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <h3>Total Revenue</h3>
            <div class="value">₱{{ number_format($payments->where('status', 'completed')->sum('amount'), 2) }}</div>
        </div>
            ...
            <div class="stat-card warning">
                ...
                <div class="value">{{ $payments->where('status', 'pending')->count() }}</div>
            </div>
        </div>
        ...
        <table id="paymentsTable">
            ...
            <tbody>
                ...
                <tr data-status="{{ $payment->status }}">
                    ...
                    <td><strong>{{ $payment->booking->student->name }}</strong></td>
                    <td>{{ $payment->booking->course->title }}</td>
                    ...
                    <td style="font-family: monospace; font-size: 0.9rem;">{{ $payment->reference ?? '-' }}</td>
