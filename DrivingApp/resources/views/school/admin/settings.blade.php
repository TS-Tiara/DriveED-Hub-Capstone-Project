...
<div class="settings-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Configure and customize settings for {{ $schoolName }}</p>
        </div>
    </div>
    ...
    <div class="settings-card">
        <div class="settings-section">
            ...
            <form method="POST" action="{{ route('schools.admin.settings.update', ['school' => $school->slug]) }}" class="settings-form" id="settingsForm">
                @csrf
                ...
                <div class="checkbox-group">
                    <input 
                        ...
                        value="1"
                        {{ old('use_gradient_header', $school->schoolSetting->use_gradient_header ?? true) ? 'checked' : '' }}
                    >
                ...
                <div class="color-grid">
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper @error('primary_color') is-invalid @enderror">
                            <div class="color-preview-container">
                                <input 
                                    type="color" 
                                    id="primary_color_picker" 
                                    value="{{ old('primary_color', $school->schoolSetting->primary_color ?? '#2563eb') }}"
                                    class="color-preview"
                            ...
                            <input 
                                ...
                                id="primary_color" 
                                name="primary_color" 
                                class="color-input @error('primary_color') is-invalid @enderror"
                                value="{{ old('primary_color', $school->schoolSetting->primary_color ?? '#2563eb') }}"
                                pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper @error('secondary_color') is-invalid @enderror">
                            <input 
                                type="color" 
                                id="secondary_color_picker" 
                                value="{{ old('secondary_color', $school->schoolSetting->secondary_color ?? '#fbbf24') }}"
                                class="color-preview"
                            ...
                            <input 
                                ...
                                class="color-input @error('secondary_color') is-invalid @enderror"
                                value="{{ old('secondary_color', $school->schoolSetting->secondary_color ?? '#fbbf24') }}"
                                pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper @error('accent_color') is-invalid @enderror">
                            <input 
                                type="color" 
                                id="accent_color_picker" 
                                value="{{ old('accent_color', $school->schoolSetting->accent_color ?? '#1e40af') }}"
                                class="color-preview"
                            ...
                            <input 
                                ...
                                id="accent_color" 
                                name="accent_color" 
                                class="color-input @error('accent_color') is-invalid @enderror"
                                value="{{ old('accent_color', $school->schoolSetting->accent_color ?? '#1e40af') }}"
                                pattern="^#[0-9A-Fa-f]{6}$"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('sidebar_bg_color', $school->schoolSetting->sidebar_bg_color ?? '#ffffff') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('sidebar_text_color', $school->schoolSetting->sidebar_text_color ?? '#333333') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('sidebar_hover_color', $school->schoolSetting->sidebar_hover_color ?? '#f5f5f5') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_primary_bg', $school->schoolSetting->button_primary_bg ?? '#667eea') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_primary_text', $school->schoolSetting->button_primary_text ?? '#ffffff') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_success_bg', $school->schoolSetting->button_success_bg ?? '#28a745') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_success_text', $school->schoolSetting->button_success_text ?? '#ffffff') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_danger_bg', $school->schoolSetting->button_danger_bg ?? '#dc3545') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('button_danger_text', $school->schoolSetting->button_danger_text ?? '#ffffff') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('modal_header_bg', $school->schoolSetting->modal_header_bg ?? '#667eea') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('modal_header_text', $school->schoolSetting->modal_header_text ?? '#ffffff') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('modal_border_color', $school->schoolSetting->modal_border_color ?? '#667eea') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('card_border_color', $school->schoolSetting->card_border_color ?? '#e5e7eb') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('card_header_bg', $school->schoolSetting->card_header_bg ?? '#f9fafb') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('page_header_border', $school->schoolSetting->page_header_border ?? '#667eea') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_pending_bg', $school->schoolSetting->badge_pending_bg ?? '#fbbf24') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_pending_text', $school->schoolSetting->badge_pending_text ?? '#78350f') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_approved_bg', $school->schoolSetting->badge_approved_bg ?? '#10b981') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_approved_text', $school->schoolSetting->badge_approved_text ?? '#065f46') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_cancelled_bg', $school->schoolSetting->badge_cancelled_bg ?? '#ef4444') }}"
                                class="color-preview"
                    ...
                    <div class="color-picker-group">
                        ...
                        <div class="color-input-wrapper">
                            <input 
                                ...
                                value="{{ old('badge_cancelled_text', $school->schoolSetting->badge_cancelled_text ?? '#7f1d1d') }}"
                                class="color-preview"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            name="border_radius" 
                            class="form-range"
                            value="{{ old('border_radius', $school->schoolSetting->border_radius ?? 8) }}"
                            min="0"
                            max="30"
                            oninput="document.getElementById('border_radius_value').textContent = this.value"
                        >
                        <span class="input-suffix"><span id="border_radius_value">{{ old('border_radius', $school->schoolSetting->border_radius ?? 8) }}</span> px</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            class="form-range"
                            value="{{ old('button_border_radius', $school->schoolSetting->button_border_radius ?? 8) }}"
                            min="0"
                            max="30"
                            oninput="document.getElementById('button_border_radius_value').textContent = this.value"
                        >
                        <span class="input-suffix"><span id="button_border_radius_value">{{ old('button_border_radius', $school->schoolSetting->button_border_radius ?? 8) }}</span> px</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            class="form-control @error('instructor_removal_notice_days') is-invalid @enderror"
                            value="{{ old('instructor_removal_notice_days', $school->instructor_removal_notice_days ?? 7) }}"
                            min="0"
                            max="30"
                            required
                        >
                    ...
                    @error('instructor_removal_notice_days')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
