...
<div class="theoretical-container">
    ...
    <div class="tab-panel active" id="tab-training">
        ...
        <div class="mt-4 px-4">
            {{ $activeEnrollments->appends(['passed_page' => $passedStudents->currentPage()])->links() }}
        </div>
    </div>
    ...
    <div class="tab-panel" id="tab-passed">
                    ...
                    <tbody id="passedTableBody">
                        @foreach($passedStudents as $student)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ school_route('admin.userManagement') }}" class="btn-action btn-view" title="View Student Profile">
        ...
        <div class="mt-4 px-4">
            {{ $passedStudents->appends(['active_page' => $activeEnrollments->currentPage()])->links() }}
        </div>
    </div>
</div>
...
<div class="modal-overlay" id="confirmModal">
    <div class="modal-box">
        ...
        <form id="markPassedForm" method="POST" action="{{ school_route('admin.theoretical.markAsPassed') }}">
            @csrf
