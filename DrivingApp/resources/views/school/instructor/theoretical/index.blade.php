                    ...
                    <tbody id="passedTableBody">
                        @foreach($passedStudents as $student)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ $schoolRoute('instructor.students.show', ['id' => $student->id]) }}" class="btn-action btn-view" title="View Student Profile">
...
<div class="modal-overlay" id="confirmModal">
    <div class="modal-box">
        ...
        <form id="markPassedForm" method="POST" action="{{ $schoolRoute('instructor.theoretical.markAsPassed') }}">
            @csrf
