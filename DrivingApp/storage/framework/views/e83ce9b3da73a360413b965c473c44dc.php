...
<style>
    ...
    .stat-box:nth-child(2)::before { background: <?php echo e($settings->primary_color ?? '#10b981'); ?>; }
    .stat-box:nth-child(3)::before { background: #dc2626; }
    .stat-box:nth-child(4)::before { background: <?php echo e($settings->primary_color ?? '#f59e0b'); ?>; }

    .stat-box:nth-child(1) .stat-value { color: #3b82f6; }
    .stat-box:nth-child(2) .stat-value { color: <?php echo e($settings->primary_color ?? '#10b981'); ?>; }
    .stat-box:nth-child(3) .stat-value { color: #dc2626; }
    .stat-box:nth-child(4) .stat-value { color: <?php echo e($settings->primary_color ?? '#f59e0b'); ?>; }
    ...
    /* Controls Bar */
    .controls-bar {
        background: <?php echo e($settings->primary_color ?? '#1e40af'); ?>;
        padding: 20px 30px;
        border-radius: 12px;
        display: flex;
        align-items: center;
    ...
    .student-card:hover {
        ...
        border-color: <?php echo e($school->schoolSetting->primary_color ?? '#f59e0b'); ?>;
    }
    ...
    .student-grade {
        font-size: 1.1rem;
        color: <?php echo e($school->schoolSetting->primary_color ?? '#f59e0b'); ?>;
        font-weight: 700;
        margin-top: 4px;
    }
    ...
    .badge-assigned {
        background: rgba(<?php echo e(hexdec(substr($school->schoolSetting->primary_color ?? '#1e40af', 1, 2))); ?>, <?php echo e(hexdec(substr($school->schoolSetting->primary_color ?? '#1e40af', 3, 2))); ?>, <?php echo e(hexdec(substr($school->schoolSetting->primary_color ?? '#1e40af', 5, 2))); ?>, 0.15);
        color: <?php echo e($school->schoolSetting->primary_color ?? '#1e40af'); ?>;
    }
...
<div class="students-container">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-box">
            ...
            <div class="stat-value"><?php echo e($myStudents); ?></div>
        </div>
        <div class="stat-box">
        ...
        <div class="stat-box">
            ...
            <div class="stat-value"><?php echo e(number_format($avgProgress, 0)); ?></div>
        </div>
    </div>
    ...
    <div class="controls-bar">
        ...
        <div class="view-count">
            Showing <span id="showingCount"><?php echo e($totalStudents); ?></span> Students
        </div>
    </div>
    ...
    <div class="students-grid" id="studentsGrid">
        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="student-card" 
                 ...
                 data-progress="<?php echo e($student->avg_progress ?? 0); ?>"
                 data-sessions="<?php echo e($student->sessions_count); ?>"
                 data-assigned="<?php echo e($student->is_assigned ? 'true' : 'false'); ?>"
                 onclick="window.location.href='<?php echo e($schoolRoute('instructor.students.show', ['id' => $student->id])); ?>'">
                <div class="student-card-header">
                    ...
                    <div class="student-info">
                        ...
                        <div class="student-detail"><strong>Email:</strong> <?php echo e($student->email); ?></div>
                        <div class="student-detail"><strong>Contact:</strong> <?php echo e($student->contact ?? 'N/A'); ?></div>
                        <?php if($student->avg_progress): ?>
                            <div class="student-grade"><strong>Grade:</strong> <?php echo e(number_format($student->avg_progress, 1)); ?>%</div>
                        <?php else: ?>
                            <div class="student-grade"><strong>Grade:</strong> -</div>
                        <?php endif; ?>
                        <div class="assignment-badge <?php echo e($student->is_assigned ? 'badge-assigned' : 'badge-unassigned'); ?>">
                            <?php echo e($student->is_assigned ? 'My Student' : 'Other'); ?>
...
<?php echo $__env->make($isAjax ?? false ? 'layouts.ajax' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\school\instructor\students.blade.php ENDPATH**/ ?>