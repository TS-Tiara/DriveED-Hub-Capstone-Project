...
<style>
    ...
    .btn-create {
        ...
        <?php if($settings?->use_gradient_header): ?>
            background: linear-gradient(135deg, <?php echo e($settings->primary_color); ?> 0%, <?php echo e($settings->secondary_color); ?> 100%);
        <?php else: ?>
    ...
    .course-card {
        ...
        border-left: 4px solid <?php echo e($settings->primary_color ?? '#667eea'); ?>;
        position: relative;
    }
    ...
    .btn-preview {
        background: <?php echo e($settings->accent_color ?? '#8b5cf6'); ?>;
        color: white;
    }
    ...
    .modal-header {
        ...
        justify-content: space-between;
        align-items: center;
        background: <?php echo e($settings->modal_header_bg ?? $settings->primary_color ?? '#667eea'); ?>;
        color: white;
...
<div class="courses-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Manage courses, packages, and pricing for <?php echo e($schoolName); ?></p>
        </div>
                ...
                <div class="course-card">
                    <div style="position: relative;">
                        <?php if($course->banner_image && file_exists(public_path($course->banner_image))): ?>
                            <img src="<?php echo e(asset($course->banner_image)); ?>" alt="<?php echo e($course->title); ?>" class="course-banner">
                        <?php else: ?>
                    ...
                    <div class="course-content">
                        <div class="course-header">
                            <div>
                                ...
                                <span class="course-type"><?php echo e($course->type); ?></span>
                                <?php if($course->vehicle_type): ?>
                                    <span class="course-type" style="background: #dbeafe; color: #1e40af;"><?php echo e($course->vehicle_type); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <?php if($course->features && count($course->features) > 0): ?>
                            <ul class="course-features">
                                <?php $__currentLoopData = array_slice($course->features, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($feature); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($course->features) > 3): ?>
                                    <li style="color: <?php echo e($settings->primary_color ?? '#667eea'); ?>; font-weight: 600;">+<?php echo e(count($course->features) - 3); ?> more features</li>
                                <?php endif; ?>
                            </ul>
                        <?php endif; ?>
                        ...
                        <?php if($course->packages && $course->packages->count() > 0): ?>
                            <div class="packages-section">
                                <div class="packages-header">
                                    <span class="packages-title">📦 Packages (<?php echo e($course->packages->count()); ?>)</span>
                                    <button class="btn-add-package" onclick="openPackageModal(<?php echo e($course->id); ?>, null)">
                                    ...
                                    <div class="package-item">
                                        <div class="package-info">
                                            <div class="package-name">
                                                ...
                                                <?php if($package->vehicle_type): ?>
                                                    <span style="font-size: 0.8rem; padding: 2px 8px; background: <?php echo e($settings->accent_color ?? '#8b5cf6'); ?>; color: white; border-radius: 10px; margin-left: 5px;">
                                                        <?php echo e($package->vehicle_type); ?>

                                                    </span>
                                                <?php endif; ?>
                                                <span style="font-size: 0.8rem; padding: 2px 8px; background: <?php echo e($package->transmission_type == 'manual' ? '#fbbf24' : '#3b82f6'); ?>; color: white; border-radius: 10px; margin-left: 5px;">
                                                    <?php echo e(strtoupper($package->transmission_type)); ?>
                                            ...
                                            <div class="package-details">
                                                ...
                                                <?php if($package->description): ?> <?php echo e(Str::limit($package->description, 40)); ?> <?php endif; ?>
                                            </div>
                                        </div>
                                        <span class="package-price">₱<?php echo e(number_format($package->price, 2)); ?></span>
                                        <div style="display: flex; gap: 5px;">
                                            <button class="btn-package-edit" onclick="openPackageModal(<?php echo e($course->id); ?>, <?php echo e($package->id); ?>)">Edit</button>
                                            <button class="btn-package-delete" onclick="deletePackage(<?php echo e($course->id); ?>, <?php echo e($package->id); ?>)">Delete</button>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php else: ?>
                            <div class="packages-section">
                                <button class="btn-add-package" style="width: 100%;" onclick="openPackageModal(<?php echo e($course->id); ?>, null)">
                        ...
                        <div class="course-actions">
                            <button class="btn-preview" onclick="openPreviewModal(<?php echo e($course->id); ?>)" title="Preview how guests see this course">
                                <i class="bi bi-eye-fill"></i> Preview
                            </button>
                            <button class="btn-edit" onclick="openEditModal(<?php echo e($course->id); ?>)">
                                <i class="bi bi-pencil-fill"></i> Edit
                            </button>
                            <button class="btn-delete" onclick="deleteCourse(<?php echo e($course->id); ?>)">
        ...
        <div class="courses-list">
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="course-list-item">
                    <?php if($course->banner_image && file_exists(public_path($course->banner_image))): ?>
                        <img src="<?php echo e(asset($course->banner_image)); ?>" alt="<?php echo e($course->title); ?>" class="course-list-banner">
                    <?php else: ?>
                    ...
                    <div class="course-list-content">
                        <div class="course-list-header">
                            <div class="course-list-title-section">
                                <h3 class="course-title" style="margin-bottom: 10px;"><?php echo e($course->title); ?></h3>
                                <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 10px;">
                                    <span class="course-type"><?php echo e($course->type); ?></span>
                                    <?php if($course->vehicle_type): ?>
                                        <span class="course-type" style="background: #dbeafe; color: #1e40af;"><?php echo e($course->vehicle_type); ?></span>
                                    <?php endif; ?>
                                    <span class="status-badge status-<?php echo e($course->status); ?>" style="position: static;">
                                        <?php echo e(ucfirst($course->status)); ?>
                                ...
                                <?php if($course->description): ?>
                                    <p class="course-description" style="-webkit-line-clamp: 3; display: -webkit-box; -webkit-box-orient: vertical; overflow: hidden;"><?php echo e($course->description); ?></p>
                                <?php endif; ?>
                        ...
                        <?php if($course->packages && $course->packages->count() > 0): ?>
                            <div class="course-list-info">
                                <div class="info-item">
                                    ...
                                    <span class="info-value"><?php echo e($course->packages->count()); ?></span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Price Range</span>
                                    <span class="info-value">
                                        ₱<?php echo e(number_format($course->packages->min('price'), 0)); ?> - ₱<?php echo e(number_format($course->packages->max('price'), 0)); ?>
                                        ...
                                        <?php $__currentLoopData = $course->packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="package-inline-item">
                                                <div class="package-inline-name">
                                                    ...
                                                    <?php if($package->vehicle_type): ?>
                                                        <span style="font-size: 0.75rem; padding: 2px 6px; background: <?php echo e($settings->accent_color ?? '#8b5cf6'); ?>; color: white; border-radius: 8px; margin-left: 4px;">
                                                            <?php echo e($package->vehicle_type); ?>

                                                        </span>
                                                    <?php endif; ?>
                                                    <span style="font-size: 0.75rem; padding: 2px 6px; background: <?php echo e($package->transmission_type == 'manual' ? '#fbbf24' : '#3b82f6'); ?>; color: white; border-radius: 8px; margin-left: 4px;">
                                                        <?php echo e(strtoupper($package->transmission_type)); ?>

                                                    </span>
                                                </div>
                                                <div class="package-inline-price">₱<?php echo e(number_format($package->price, 2)); ?></div>
...
<div class="modal" id="previewModal">
    <div class="modal-content" style="max-width: 900px;">
        <div class="modal-header" style="background: <?php echo e($settings->modal_header_bg ?? $settings->primary_color ?? '#667eea'); ?>;">
...
<script>
    const coursesData = <?php echo json_encode($courses, 15, 512) ?>;
    ...
    function openCreateModal() {
        ...
        document.getElementById('courseForm').action = '<?php echo e(route("schools.admin.courses.store", $school)); ?>';
    ...
    function openEditModal(courseId) {
        ...
        document.getElementById('courseForm').action = `<?php echo e(url($school->slug . '/admin/courses')); ?>/${courseId}`;
        ...
        if (course.banner_image) {
            ...
            preview.src = '<?php echo e(asset("")); ?>' + course.banner_image;
    ...
    function deleteCourse(courseId) {
        showConfirm({
            ...
            onConfirm: () => {
                ...
                form.method = 'POST';
                form.action = `<?php echo e(url($school->slug . '/admin/courses')); ?>/${courseId}`;
    ...
    function openPackageModal(courseId, packageId) {
        ...
        if (packageId) {
            ...
            document.getElementById('packageForm').action = `<?php echo e(url($school->slug . '/admin/courses')); ?>/${courseId}/packages/${packageId}`;
            ...
            document.getElementById('packageForm').action = `<?php echo e(url($school->slug . '/admin/courses')); ?>/${courseId}/packages`;
    ...
    function deletePackage(courseId, packageId) {
        showConfirm({
            ...
            onConfirm: () => {
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `<?php echo e(url($school->slug . '/admin/courses')); ?>/${courseId}/packages/${packageId}`;
    ...
    function openPreviewModal(courseId) {
        ...
        const previewHTML = `
            <div style="background: <?php echo e($settings?->use_gradient_header ? 'linear-gradient(135deg, ' . $settings->primary_color . ' 0%, ' . $settings->secondary_color . ' 100%)' : ($settings->primary_color ?? '#667eea')); ?>; padding: 40px; color: white; text-align: center;">
                ${course.banner_image ? 
                    `<img src="<?php echo e(asset('')); ?>${course.banner_image}" style="max-width: 600px; width: 100%; border-radius: 12px; margin-bottom: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">` : 
                    ...
                    <div style="margin-bottom: 40px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; max-width: 800px; margin: 0 auto;">
                            ${course.features.map(feature => `
                                <div style="background: #f8fafc; padding: 15px 20px; border-radius: 10px; border-left: 4px solid <?php echo e($settings->primary_color ?? '#667eea'); ?>;">
                            ...
                            ${course.packages.map(pkg => `
                                <div style="background: white; border: 3px solid ${pkg.is_popular ? '#f59e0b' : '#e2e8f0'}; border-radius: 12px; padding: 25px; position: relative; transition: all 0.3s; ${pkg.is_popular ? 'box-shadow: 0 8px 25px rgba(245, 158, 11, 0.3);' : ''}">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px; flex-wrap: wrap;">
                                        ${pkg.vehicle_type ? `<span style="background: <?php echo e($settings->accent_color ?? '#8b5cf6'); ?>; color: white; padding: 5px 12px; border-radius: 6px; font-weight: 600; font-size: 0.85rem;">${pkg.vehicle_type}</span>` : ''}
                                    ...
                                    <div style="margin-top: 25px; padding-top: 20px; border-top: 2px solid #e2e8f0;">
                                        <div style="font-size: 2.5rem; font-weight: 700; color: <?php echo e($settings->primary_color ?? '#667eea'); ?>;">₱${new Intl.NumberFormat().format(pkg.price)}</div>
                                    </div>
                                </div>
                            `).join('')}
                        </div>
...
<?php echo $__env->make($isAjax ?? false ? 'layouts.ajax' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views/school/admin/courses.blade.php ENDPATH**/ ?>