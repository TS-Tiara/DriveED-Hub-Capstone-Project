...
<div style="padding: 20px; margin: 20px auto; max-width: 1600px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; padding-bottom: 15px; border-bottom: 3px solid <?php echo e($primaryColor); ?>;">
        <div>
            ...
            <p style="color: #6b7280; font-size: 0.9rem; margin-top: 5px;">Recent activities and audit logs for <?php echo e($schoolName); ?></p>
        </div>
    </div>
...
<?php echo $__env->make($isAjax ?? false ? 'layouts.ajax' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\school\admin\reports\logs.blade.php ENDPATH**/ ?>