...
<div class="user-management-container">
    ...
    <div class="stats-grid">
        <div class="stat-card total">
            ...
            <div class="stat-breakdown"><?php echo e($totalStudents); ?> Students · <?php echo e($totalInstructors); ?> Instructors</div>
        </div>
        
        <div class="stat-card active">
            <div class="stat-label">Active Users</div>
            <div class="stat-value"><?php echo e($totalActive); ?></div>
            <div class="stat-breakdown"><?php echo e($activeStudents); ?> Students · <?php echo e($activeInstructors); ?> Instructors</div>
        </div>
        
        <div class="stat-card inactive">
            <div class="stat-label">Inactive Users</div>
            <div class="stat-value"><?php echo e($totalInactive); ?></div>
            <div class="stat-breakdown"><?php echo e($inactiveStudents); ?> Students · <?php echo e($inactiveInstructors); ?> Instructors</div>
        </div>
        
        <div class="stat-card students">
            <div class="stat-label">Students</div>
            <div class="stat-value"><?php echo e($totalStudents); ?></div>
            <div class="stat-breakdown"><?php echo e($activeStudents); ?> Active · <?php echo e($inactiveStudents); ?> Inactive</div>
        </div>
        
        <div class="stat-card instructors">
            <div class="stat-label">Instructors</div>
            <div class="stat-value"><?php echo e($totalInstructors); ?></div>
            <div class="stat-breakdown"><?php echo e($activeInstructors); ?> Active · <?php echo e($inactiveInstructors); ?> Inactive</div>
        </div>
    </div>
    ...
    <div class="tabs-container">
        <div class="tabs">
            <button class="tab active" onclick="switchTab('students')">Students (<?php echo e($totalStudents); ?>)</button>
            <button class="tab" onclick="switchTab('instructors')">Instructors (<?php echo e($totalInstructors); ?>)</button>
        </div>
    </div>
