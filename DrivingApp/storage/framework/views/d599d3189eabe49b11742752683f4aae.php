...
<div class="topbar">
    <div class="topbar-left">
        <div class="school-logo">
            ...
            <span class="school-name"><?php echo e($schoolName ?? 'Driving School'); ?></span>
        </div>
    </div>
    ...
    <div class="topbar-right">
        ...
        <div class="topbar-profile" onclick="toggleProfileMenu()">
            <div class="profile-avatar">
                ...
                <?php elseif(Auth::guard('instructor')->check()): ?>
                    <?php echo e(strtoupper(substr(Auth::guard('instructor')->user()->name, 0, 1))); ?>

                <?php elseif(Auth::guard('student')->check()): ?>
                    <?php echo e(strtoupper(substr(Auth::guard('student')->user()->name, 0, 1))); ?>
        ...
        <div id="profileDropdown" class="profile-dropdown">
            <?php if(Auth::guard('admin')->check()): ?>
                <a href="<?php echo e($schoolRoute('admin.profile')); ?>" class="dropdown-item">
                    Profile
                </a>
                
            <?php elseif(Auth::guard('instructor')->check()): ?>
                <a href="<?php echo e($schoolRoute('instructor.profile')); ?>" class="dropdown-item">
                    Profile
                </a>
                
            <?php elseif(Auth::guard('student')->check()): ?>
                <a href="<?php echo e($schoolRoute('student.profile')); ?>" class="dropdown-item">
                    Profile
                </a>
                
            <?php endif; ?>
            <div class="dropdown-divider"></div>
            <form method="POST" action="<?php echo e($schoolRoute('logout')); ?>">
                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\partials\topbar.blade.php ENDPATH**/ ?>