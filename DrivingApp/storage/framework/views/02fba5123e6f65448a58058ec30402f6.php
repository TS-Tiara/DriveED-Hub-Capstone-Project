...
<div class="schedule-container">
    ...
    <?php if(session('success')): ?>
        <div class="success-alert"><?php echo e(session('success')); ?></div>
    <?php endif; ?>

    <?php if(session('error')): ?>
        <div class="error-alert"><?php echo e(session('error')); ?></div>
    <?php endif; ?>
    ...
    <div class="stats-row">
        <div class="stat-card">
            <div class="stat-number"><?php echo e($totalMySlots); ?></div>
            <div class="stat-label">My Scheduled Slots</div>
        </div>
        <div class="stat-card">
            <div class="stat-number"><?php echo e($adminAssigned); ?></div>
            <div class="stat-label">Admin Assigned</div>
        </div>
        <div class="stat-card">
            <div class="stat-number"><?php echo e($selfSelected); ?></div>
    ...
    <div id="list-view" class="view-content active">
        ...
        <?php if($allTimeSlots->isEmpty()): ?>
            <div class="no-schedule">
                <h3>No Schedule Available</h3>
                <p>There are currently no time slots available</p>
            </div>
        <?php else: ?>
            <?php $__currentLoopData = $groupedSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weekStart => $weekSlots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="week-section">
                    <div class="week-header collapsible-header" onclick="toggleWeek('<?php echo e($weekId); ?>')">
                        <span style="font-size: 1.2rem;">📅</span>
                        <span>Week of <?php echo e(\Carbon\Carbon::parse($weekStart)->format('M j')); ?> - <?php echo e($weekEnd->format('M j, Y')); ?></span>
                        <div class="week-stats">
                            <span class="week-stat-badge"><?php echo e($weekMySlots); ?> My Slots</span>
                            <span class="week-stat-badge"><?php echo e($weekAvailableSlots); ?> Available</span>
                        </div>
                        <span class="collapse-icon" id="<?php echo e($weekId); ?>-icon">▼</span>
                    </div>
                    
                    <div class="collapsible-content" id="<?php echo e($weekId); ?>-content">
                    <?php $__currentLoopData = $weekSlots->groupBy('date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $daySlots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="day-section">
                            ...
                            <?php $__currentLoopData = $daySlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="schedule-card <?php echo e($isMySlot ? 'my-schedule' : 'available'); ?>">
                                    <div class="schedule-header">
                                        <div class="schedule-time">
                                            <span style="color: #6c757d;">🕐</span>
                                            <span><?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i A')); ?>

                                            - <?php echo e(\Carbon\Carbon::parse($slot->end_time)->format('g:i A')); ?></span>
                                        </div>
                                        <?php if($isMySlot): ?>
                                            ...
                                            <?php else: ?>
                                                <span class="schedule-status <?php echo e($assignmentType === 'admin_assigned' ? 'admin' : 'assigned'); ?>">
                                                <?php echo e($assignmentType === 'admin_assigned' ? 'ADMIN ASSIGNED' : 'MY SLOT'); ?>
                                    ...
                                    <div class="schedule-details">
                                        <div class="schedule-detail-item">
                                            ...
                                            <span><?php echo e($slot->instructors->count()); ?> / <?php echo e($slot->max_instructors); ?></span>
                                        </div>
                                        <?php if($slot->notes): ?>
                                            <div class="schedule-detail-item">
                                                <span>Notes:</span>
                                                <span><?php echo e($slot->notes); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($isMySlot && $assignmentType === 'admin_assigned' && !$hasPendingRequest): ?>
                                            ...
                                            <?php if(!$canRequestRemoval): ?>
                                                <div class="schedule-detail-item" style="color: #f44336;">
                                                    <span>Warning:</span>
                                                    <span>Must request removal at least <?php echo e($minimumNoticeDays); ?> days in advance (<?php echo e($daysUntilSlot); ?> day(s) remaining)</span>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if($hasPendingRequest): ?>
                                    ...
                                    <?php if($isMySlot && $assignmentType === 'admin_assigned' && !$hasPendingRequest): ?>
                                        <div class="schedule-action">
                                            <button type="button" class="btn btn-request" 
                                                    ...
                                                    <?php if(!$canRequestRemoval): ?> disabled style="opacity: 0.5; cursor: not-allowed;" <?php endif; ?>>
                                                Request Removal
                                            </button>
                                        </div>
                                    <?php elseif(!$isMySlot || ($isMySlot && $assignmentType === 'self_selected')): ?>
                                        <div class="schedule-action">
                                            <form method="POST" action="<?php echo e($schoolRoute('instructor.timeslots.toggle', ['id' => $slot->id])); ?>">
                                                <?php echo csrf_field(); ?>
                                                <?php if($isMySlot): ?>
            ...
            <?php while($currentDate <= $calendarEnd): ?>
                ...
                <div class="calendar-day <?php echo e($isOtherMonth ? 'other-month' : ''); ?> <?php echo e($isToday ? 'today' : ''); ?> <?php echo e($hasSchedule && !$isOtherMonth ? 'has-schedule clickable' : ''); ?>"
                    ...
                    <?php if(!$isOtherMonth && $hasSchedule): ?>
                        <div class="day-slots">
                            <?php $__currentLoopData = $myDaySlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $instructor = $slot->instructors->firstWhere('id', $instructorId);
                                    $isAdminAssigned = $instructor && $instructor->pivot->assignment_type === 'admin_assigned';
                                ?>
                                <div class="slot-badge assigned" title="<?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($slot->end_time)->format('g:i A')); ?> <?php echo e($isAdminAssigned ? '(Admin)' : ''); ?>">
                                    <?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i A')); ?>

                                    <?php echo e($isAdminAssigned ? '(A)' : ''); ?>

                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            
                            <?php $__currentLoopData = $availableDaySlots->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!$slot->hasInstructor($instructorId)): ?>
                                    <div class="slot-badge available" title="Available: <?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($slot->end_time)->format('g:i A')); ?>">
                                        <?php echo e(\Carbon\Carbon::parse($slot->start_time)->format('g:i A')); ?>
                            ...
                            <?php if($availableDaySlots->count() > 2): ?>
                                <div class="slot-badge available">
                                    +<?php echo e($availableDaySlots->count() - 2); ?> more
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
...
<div id="schedulesData" style="display: none;">
    ...
    ?>
    <script>
        window.schedulesData = <?php echo json_encode($schedulesJson, 15, 512) ?>;
    </script>
</div>

<script>
    // Current month tracking
    let currentMonthDate = new Date('<?php echo e($calendar->format('Y-m-01')); ?>');
    const instructorId = <?php echo e($instructorId); ?>;
    ...
    function changeMonth(direction) {
        ...
        fetch(`<?php echo e(route('schools.instructor.schedule', ['school' => $school->slug])); ?>?month=${monthStr}&ajax=1`, {
            headers: {
    ...
    function showRemovalRequestModal(slotId, canRequest, minimumDays, daysRemaining) {
        ...
        form.action = `<?php echo e(route('schools.instructor.timeslots.requestRemoval', ['school' => $school->slug, 'id' => '__SLOT_ID__'])); ?>`.replace('__SLOT_ID__', slotId);
...
<?php echo $__env->make($isAjax ?? false ? 'layouts.ajax' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views/school/instructor/schedule.blade.php ENDPATH**/ ?>