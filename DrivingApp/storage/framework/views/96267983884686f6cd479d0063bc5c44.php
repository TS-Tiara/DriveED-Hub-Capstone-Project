                        ...
                        <td>
                            <?php if($request->status === 'pending'): ?>
                                <div class="action-buttons">
                                    <form method="POST" action="<?php echo e(route('schools.admin.enrollmentRequests.approve', ['school' => $school, 'enrollmentRequest' => $request->id])); ?>" style="display: inline;" id="approveForm<?php echo e($request->id); ?>">
                                        <?php echo csrf_field(); ?>
