    ...
    <div class="courses-grid">
        ...
        <div class="course-card">
            ...
            <div class="course-body">
                    ...
                    <div class="packages-section">
                        ...
                        <?php $__currentLoopData = $course->packages->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="package-item">
                                ...
                                <span class="package-price">P<?php echo e(number_format($package->price, 2)); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php else: ?>
                    <div class="course-info">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">P<?php echo e(number_format($course->price, 2)); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php elseif($course->max_students && $course->availableSlots() <= 3 && $course->availableSlots() > 0): ?>
                    <div class="course-warning">Only <?php echo e($course->availableSlots()); ?> slot<?php echo e($course->availableSlots() == 1 ? '' : 's'); ?> left!</div>
                    <button class="btn-enroll" onclick="bookCourse(<?php echo e($course->id); ?>)">Enroll Now</button>
                <?php else: ?>
                    <button class="btn-enroll" onclick="bookCourse(<?php echo e($course->id); ?>)">Enroll Now</button>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\school\student\courses.blade.php ENDPATH**/ ?>