            ...
            <tbody>
                ...
                <div class="payment-card">
                    <div class="payment-card-row">
                        ...
                        <span class="payment-card-value"><?php echo e($payment->paid_on ? $payment->paid_on->format('M d, Y') : 'N/A'); ?></span>
                    </div>
                    <div class="payment-card-row">
                        <span class="payment-card-label">Course</span>
                        <span class="payment-card-value"><?php echo e($payment->booking->course->title); ?></span>
                    </div>
                    <div class="payment-card-row">
                        <span class="payment-card-label">Amount</span>
                        <span class="payment-card-amount">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
                    </div>
                    <div class="payment-card-row">
                        <span class="payment-card-label">Method</span>
                        <span class="payment-card-value"><?php echo e(ucfirst($payment->method ?? 'N/A')); ?></span>
                    </div>
                    <div class="payment-card-row">
                        <span class="payment-card-label">Status</span>
                        <span class="badge badge-<?php echo e($payment->status); ?>"><?php echo e(ucfirst($payment->status)); ?></span>
                    </div>
                </div>
