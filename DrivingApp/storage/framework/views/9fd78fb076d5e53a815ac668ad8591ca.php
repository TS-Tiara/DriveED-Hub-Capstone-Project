...
<style>
    ...
    .btn {
        ...
        border-radius: <?php echo e($settings->button_border_radius ?? '8px'); ?>;
    ...
    .btn-outline {
        ...
        border-color: <?php echo e($settings->primary_color); ?>;
    }
    ...
    .about-icon {
        ...
        height: 48px;
        border-radius: 10px;
        background: linear-gradient(135deg, <?php echo e($settings->primary_color); ?>20 0%, <?php echo e($settings->primary_color); ?>10 100%);
        color: <?php echo e($settings->primary_color); ?>;
        display: flex;
        align-items: center;
...
<div class="guest-dashboard">
    ...
    <div class="welcome-banner">
        <h1>Welcome, <?php echo e($guest->name); ?>!</h1>
        <p>Discover driving courses and start your journey with <?php echo e($school->name); ?></p>
    </div>
    
    <!-- Enrollment Status -->
    <div class="enrollment-status">
        <?php if($approvedEnrollment): ?>
            <div class="status-message enrolled">
                ...
                <div>
                    <strong>You're enrolled!</strong> You are enrolled in <strong><?php echo e($approvedEnrollment->course->title); ?></strong>.
                </div>
            </div>
        <?php elseif($pendingRequest): ?>
            <div class="status-message pending">
                ...
                <div>
                    <strong>Request pending.</strong> Your enrollment request for <strong><?php echo e($pendingRequest->course->title); ?></strong> is under review.
                </div>
            </div>
        <?php else: ?>
    ...
    <div class="section">
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('schools.guest.courses', $school)); ?>" class="btn btn-primary">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 20px; height: 20px;">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                Browse All Courses
            </a>
            <a href="<?php echo e(route('schools.guest.enrollmentRequests', $school)); ?>" class="btn btn-outline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 20px; height: 20px;">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                My Requests
    ...
    <!-- About Section -->
    <div class="section">
        <h2 class="section-title">About <?php echo e($school->name); ?></h2>
        <p class="section-description">
            <?php echo e($school->description ?? 'We are committed to providing quality driving education to help you become a safe and confident driver.'); ?>
