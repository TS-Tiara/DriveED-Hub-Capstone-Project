...
<style>
    ...
    .request-card {
        ...
        margin-bottom: 20px;
        overflow: hidden;
        border-left: 5px solid <?php echo e($school->schoolSetting->primary_color ?? '#667eea'); ?>;
...
<div class="container">
    ...
    <?php if($enrollmentRequests->count() > 0): ?>
        <div class="requests-list">
            <?php $__currentLoopData = $enrollmentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="request-card status-<?php echo e($request->status); ?>">
                    <div class="request-header">
                        <div class="course-info">
                            <div class="course-name"><?php echo e($request->course->title); ?></div>
                            <div class="course-type"><?php echo e(ucfirst($request->course->type)); ?> Course</div>
                        </div>
                    ...
                    <div class="request-body">
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <span class="info-value">₱<?php echo e(number_format($request->course->price, 2)); ?></span>
                            </div>
                            
                            <div class="info-item">
                                <span class="info-label">Payment Status</span>
                                <span class="payment-status payment-<?php echo e($request->payment_status); ?>">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value"><?php echo e($request->course->duration_hours); ?> hours</span>
                            </div>
                            
                            <div class="info-item">
                                <span class="info-label">Request Date</span>
                                <span class="info-value"><?php echo e($request->created_at->format('M d, Y')); ?></span>
                            </div>
                        </div>
                        
                        <?php if($request->status === 'rejected' && $request->remarks): ?>
                            ...
                            <div class="timeline">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div><?php echo e($request->created_at->format('M d, Y h:i A')); ?></div>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    <span class="timeline-icon">✅</span>
                                    <div class="timeline-content">
                                        ...
                                        <div>
                                            ...
                                            <?php if($request->approvedBy): ?>
                                                <span style="color: #9ca3af;"> by <?php echo e($request->approvedBy->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php elseif($request->payment_status === 'on_hold'): ?>
                                    <div class="timeline-item">
                                        <span class="timeline-icon">⏳</span>
                                        <div class="timeline-content">
