...
<?php $__env->startSection('page-title', 'Driving Schools'); ?>
...
<div class="action-bar">
    <form method="GET" class="search-box">
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search schools...">
...
<div class="card">
    <div class="card-header">
        <h3>
            ...
            All Schools (<?php echo e($schools->total()); ?>)
        </h3>
    </div>
    <div class="card-body">
                    ...
                    <td>
                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                            <div class="school-icon">
                                <?php echo e(strtoupper(substr($school->name, 0, 2))); ?>

                            </div>
                            <div>
                                <strong><?php echo e($school->name); ?></strong>
                                <?php if($school->email): ?>
                                <div style="font-size: 0.8rem; color: #6b7280;"><?php echo e($school->email); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </td>
                    <td><span class="slug-badge"><?php echo e($school->slug); ?></span></td>
                    <td><?php echo e($school->students_count); ?></td>
                    <td><?php echo e($school->instructors_count); ?></td>
                    <td>
                        <span class="status-badge <?php echo e(($school->status ?? 'active') === 'active' ? 'status-active' : 'status-inactive'); ?>">
                            <?php echo e(ucfirst($school->status ?? 'active')); ?>

                        </span>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <a href="/<?php echo e($school->slug); ?>" target="_blank" class="btn-action btn-view" title="View School">
                                <i class="fas fa-external-link-alt"></i>
                            </a>
                            <form action="<?php echo e(route('system-admin.schools.toggle-status', $school)); ?>" method="POST" style="display: inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                <button type="submit" class="btn-action <?php echo e(($school->status ?? 'active') === 'active' ? 'btn-deactivate' : 'btn-activate'); ?>" title="<?php echo e(($school->status ?? 'active') === 'active' ? 'Deactivate' : 'Activate'); ?>">
                                    <i class="fas <?php echo e(($school->status ?? 'active') === 'active' ? 'fa-ban' : 'fa-check'); ?>"></i>
                                </button>
                            </form>
                            <button type="button" class="btn-action btn-delete" onclick="confirmDelete('<?php echo e($school->id); ?>', '<?php echo e($school->name); ?>')" title="Delete School">
...
<div class="modal-overlay" id="createSchoolModal">
    <div class="modal">
        ...
        <form action="<?php echo e(route('system-admin.schools.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.system-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\system-admin\schools.blade.php ENDPATH**/ ?>