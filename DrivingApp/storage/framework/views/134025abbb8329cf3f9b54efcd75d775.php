...
<div class="bookings-container">
    ...
    <div class="stats-grid">
        <div class="stat-card scheduled">
            <div class="stat-number"><?php echo e($bookings->where('status', 'scheduled')->count()); ?></div>
            <div class="stat-label">Scheduled Bookings</div>
        </div>
        <div class="stat-card completed">
            <div class="stat-number"><?php echo e($bookings->where('status', 'completed')->count()); ?></div>
            <div class="stat-label">Completed Sessions</div>
        </div>
        <div class="stat-card cancelled">
            <div class="stat-number"><?php echo e($bookings->where('status', 'cancelled')->count()); ?></div>
            <div class="stat-label">Cancelled Bookings</div>
        </div>
        <div class="stat-card pending">
            <div class="stat-number"><?php echo e($bookings->where('status', 'pending')->count()); ?></div>
    ...
    <div class="bookings-filters">
        <button class="filter-btn active" data-filter="all" onclick="filterBookings('all')">All Bookings (<?php echo e($bookings->count()); ?>)</button>
        <button class="filter-btn" data-filter="scheduled" onclick="filterBookings('scheduled')">Scheduled (<?php echo e($bookings->where('status', 'scheduled')->count()); ?>)</button>
        <button class="filter-btn" data-filter="completed" onclick="filterBookings('completed')">Completed (<?php echo e($bookings->where('status', 'completed')->count()); ?>)</button>
        <button class="filter-btn" data-filter="cancelled" onclick="filterBookings('cancelled')">Cancelled (<?php echo e($bookings->where('status', 'cancelled')->count()); ?>)</button>
        <button class="filter-btn" data-filter="pending" onclick="filterBookings('pending')">Pending (<?php echo e($bookings->where('status', 'pending')->count()); ?>)</button>
    </div>
    ...
    <div class="bookings-list" id="bookingsList">
            ...
            <div class="booking-card" data-status="<?php echo e($booking->status); ?>">
                ...
                <div class="booking-date">
                    <?php if($booking->timeSlot): ?>
                        ...
                        <span class="time"><?php echo e(\Carbon\Carbon::parse($booking->timeSlot->start_time)->format('h:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->timeSlot->end_time)->format('h:i A')); ?></span>
                    <?php elseif($booking->scheduled_at): ?>
                        📅 <span><?php echo e($booking->scheduled_at->format('M d, Y')); ?></span>
                        <span class="time"><?php echo e($booking->scheduled_at->format('h:i A')); ?></span>
                    <?php else: ?>
            ...
            <div class="booking-details">
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($booking->student->name ?? 'N/A'); ?></span>
                </div>
                <?php if($booking->instructor): ?>
                <div class="detail-row">
                    <span class="label">Instructor</span>
                    <span class="value"><?php echo e($booking->instructor->name); ?></span>
                </div>
                <?php endif; ?>
                <?php if($booking->package): ?>
                <div class="detail-row">
                    <span class="label">Package</span>
                    <span class="value"><?php echo e($booking->package->name); ?> - <?php echo e($booking->package->transmission_type); ?></span>
                </div>
                <?php endif; ?>
                <?php if($booking->package && $booking->package->training_hours): ?>
                <div class="detail-row">
                    <span class="label">Duration</span>
                    <span class="value"><?php echo e($booking->package->training_hours); ?> hours</span>
                </div>
                <?php endif; ?>
                <div class="detail-row">
                    <span class="label">Price</span>
                    <span class="value">₱<?php echo e(number_format($booking->total_amount, 2)); ?></span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="value"><?php echo e($booking->notes); ?></span>
                </div>
                <?php endif; ?>
            </div>

            <div class="booking-actions">
                <select class="form-select" onchange="updateStatus(<?php echo e($booking->id); ?>, this.value)" style="max-width: 200px;">
                ...
                <button class="btn btn-sm btn-success" onclick="createPayment(<?php echo e($booking->id); ?>)">Record Payment</button>
                <?php else: ?>
