                                        ...
                                        <?php if(!$hasPendingRequest): ?>
                                            <div class="slot-actions">
                                                <?php if($assignmentType === 'admin_assigned'): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <form method="POST" action="<?php echo e(route('schools.instructor.timeslots.toggle', ['school' => $school->slug, 'id' => $slot->id])); ?>" style="display: inline;">
                                                        <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $dateSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="slot-item" data-qualified="<?php echo e($isQualifiedForCourse ? 'true' : 'false'); ?>" style="<?php echo e(!$isQualifiedForCourse ? 'display: none;' : ''); ?>">
                                    ...
                                    <div class="slot-details">
                                        ...
                                        <div class="slot-actions">
                                            <form method="POST" action="<?php echo e(route('schools.instructor.timeslots.toggle', ['school' => $school->slug, 'id' => $slot->id])); ?>" style="display: inline;" data-no-ajax="true">
                                                <?php echo csrf_field(); ?>
