...
<div class="progress-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Track student training progress and session attendance for <?php echo e($schoolName); ?></p>
        </div>
    </div>
    ...
    <div class="progress-table">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $progresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $progress): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $bookings = \App\Models\Booking::where('student_id', $progress->student_id)
                            ->where('course_id', $progress->course_id)
                            ->where('school_id', $school->id)
                    ...
                    <tr class="progress-row" onclick="toggleDetails(<?php echo e($index); ?>)">
                        <td><span class="expand-icon" id="icon-<?php echo e($index); ?>">▶</span></td>
                        <td><span class="student-name"><?php echo e($progress->student->name); ?></span></td>
                        <td>
                            <span class="session-info">
                                <?php echo e($completedSessions); ?> / <?php echo e($totalSessions); ?> sessions
                            </span>
                        </td>
                        <td>
                            <?php if($currentBooking && $currentBooking->instructor): ?>
                                <span class="instructor-badge">
                                    <?php echo e($currentBooking->instructor->name); ?>
                        ...
                        <td>
                            <?php if($nextBooking): ?>
                                <span class="schedule-badge">
                                    <?php echo e($nextBooking->scheduled_at->format('M d, Y h:i A')); ?>
                    ...
                    <tr class="detail-row" id="detail-<?php echo e($index); ?>">
                        <td colspan="5">
                            <div class="detail-content">
                                <div class="detail-grid">
                                    ...
                                    <div class="detail-section">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-value"><?php echo e($progress->student->name); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Email</span>
                                            <span class="detail-value"><?php echo e($progress->student->email); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Contact</span>
                                            <span class="detail-value"><?php echo e($progress->student->contact ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Status</span>
                                            <span class="detail-value">
                                                <span class="badge badge-<?php echo e(strtolower($progress->student->status)); ?>">
                                                    <?php echo e(ucfirst($progress->student->status)); ?>
                                    ...
                                    <div class="detail-section">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-value"><?php echo e($progress->course->title); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Course Type</span>
                                            <span class="detail-value"><?php echo e(ucfirst($progress->course->type)); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Duration</span>
                                            <span class="detail-value"><?php echo e($progress->course->duration_hours); ?> hours</span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Vehicle Type</span>
                                            <span class="detail-value"><?php echo e($progress->course->vehicle_type ?? 'N/A'); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-section">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-value"><?php echo e($completedSessions); ?> / <?php echo e($totalSessions); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Remaining Sessions</span>
                                            <span class="detail-value"><?php echo e(max(0, $totalSessions - $completedSessions)); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Total Bookings</span>
                                            <span class="detail-value"><?php echo e($bookings->count()); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-label">Last Session</span>
                                            <span class="detail-value">
                                                <?php echo e($currentBooking ? $currentBooking->scheduled_at->format('M d, Y') : 'N/A'); ?>
                                    ...
                                    <div class="detail-section">
                                        ...
                                        <?php if($currentBooking && $currentBooking->instructor): ?>
                                            <div class="detail-item">
                                                ...
                                                <span class="detail-value"><?php echo e($currentBooking->instructor->name); ?></span>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Email</span>
                                                <span class="detail-value"><?php echo e($currentBooking->instructor->email); ?></span>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Contact</span>
                                                <span class="detail-value"><?php echo e($currentBooking->instructor->contact ?? 'N/A'); ?></span>
                                            </div>
                                        <?php else: ?>
                                        ...
                                        <div class="progress-bar-container">
                                            <div class="progress-bar-fill" style="width: <?php echo e($progress->completion_percent); ?>%;">
                                                <?php if($progress->completion_percent > 10): ?>
                                                    <?php echo e(number_format($progress->completion_percent, 0)); ?>%
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="progress-percentage"><?php echo e(number_format($progress->completion_percent, 0)); ?>%</div>
                                    </div>
                                    <div style="margin-top: 15px; display: flex; justify-content: space-between; font-size: 0.85rem; color: #6b7280;">
                                        <span>Last Updated: <?php echo e($progress->last_updated ? $progress->last_updated->format('M d, Y h:i A') : 'Never'); ?></span>
                                        <span>
                                ...
                                <div class="notes-section">
                                    ...
                                    <p class="notes-text"><?php echo e($progress->notes); ?></p>
                                </div>
                                <?php endif; ?>
                                    ...
                                    <table style="width: 100%; margin-top: 10px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="border-bottom: 1px solid #e5e7eb;">
                                                <td style="padding: 10px; font-size: 0.85rem;"><?php echo e($booking->scheduled_at->format('M d, Y h:i A')); ?></td>
                                                <td style="padding: 10px; font-size: 0.85rem;"><?php echo e($booking->instructor->name ?? 'N/A'); ?></td>
                                                <td style="padding: 10px; font-size: 0.85rem;">
                                                    <span class="badge badge-<?php echo e(strtolower($booking->status)); ?>"><?php echo e(ucfirst($booking->status)); ?></span>
                                                </td>
                                                <td style="padding: 10px; font-size: 0.85rem;"><?php echo e(Str::limit($booking->notes ?? 'No notes', 50)); ?></td>
                                            </tr>
...
<?php echo $__env->make($isAjax ?? false ? 'layouts.ajax' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jcsdi\Documents\Driving School Management System\DrivingApp\resources\views\school\admin\progress.blade.php ENDPATH**/ ?>