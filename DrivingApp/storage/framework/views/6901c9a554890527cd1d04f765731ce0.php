                ...
                <div class="form-group" style="margin-top: 24px;">
                    <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer; font-weight: normal;">
                        ...
                        <span style="font-size: 13px; line-height: 1.4;">
                            I have read and agree to the <a href="#" onclick="showPrivacy(event)" style="color: <?php echo e($primaryColor); ?>; text-decoration: underline;">Data Privacy Policy</a>
                        </span>
                    </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label style="display: flex; align-items: flex-start; gap: 8px; cursor: pointer; font-weight: normal;">
                        ...
                        <span style="font-size: 13px; line-height: 1.4;">
                            I agree to the <a href="#" onclick="showTerms(event)" style="color: <?php echo e($primaryColor); ?>; text-decoration: underline;">Terms and Conditions</a>
                        </span>
                    </label>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="privacyModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; overflow-y: auto;">
        <div style="background: white; max-width: 600px; margin: 50px auto; border-radius: 8px; padding: 24px; position: relative;">
            ...
            <h2 style="margin-bottom: 16px; color: <?php echo e($primaryColor); ?>;">Data Privacy Policy</h2>
            <div style="line-height: 1.6; font-size: 14px; color: #333;">
                <p><strong>Effective Date:</strong> <?php echo e(date('F Y')); ?></p>
                <br>
                <p><?php echo e($schoolName); ?> ("we", "us", or "our") respects your privacy and is committed to protecting your personal information. This Data Privacy Policy explains how we collect, use, and safeguard your data.</p>
                <br>
                ...
                <p style="margin-top: 8px;"><strong>Email:</strong> <?php echo e($school->contact_email ?? 'privacy@driveedhub.com'); ?></p>
                <p><strong>Phone:</strong> <?php echo e($school->contact_number ?? 'N/A'); ?></p>
            </div>
            <button onclick="closePrivacy()" style="margin-top: 20px; background: <?php echo e($primaryColor); ?>; color: white; border: none; padding: 10px 24px; border-radius: 6px; cursor: pointer; width: 100%;">I Understand</button>
        </div>
    </div>
    ...
    <div id="termsModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; overflow-y: auto;">
        <div style="background: white; max-width: 600px; margin: 50px auto; border-radius: 8px; padding: 24px; position: relative;">
            ...
            <h2 style="margin-bottom: 16px; color: <?php echo e($primaryColor); ?>;">Terms and Conditions</h2>
            <div style="line-height: 1.6; font-size: 14px; color: #333;">
                <p><strong>Effective Date:</strong> <?php echo e(date('F Y')); ?></p>
                <br>
                <p>By creating an account with <?php echo e($schoolName); ?>, you agree to the following terms and conditions:</p>
                <br>
            ...
            <button onclick="closeTerms()" style="margin-top: 20px; background: <?php echo e($primaryColor); ?>; color: white; border: none; padding: 10px 24px; border-radius: 6px; cursor: pointer; width: 100%;">I Agree</button>
        </div>
    </div>
