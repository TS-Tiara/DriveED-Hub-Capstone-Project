                            ...
                            <div class="timeslot-row">
                                ...
                                <div class="timeslot-actions">
                                    <div class="action-buttons">
                                        ...
                                        <form method="POST" action="<?php echo e(route('schools.admin.schedules.delete', [$school, $timeslot->id])); ?>" onsubmit="return confirm('Are you sure you want to delete this schedule?');" style="display: inline;">
                                            <?php echo csrf_field(); ?>
